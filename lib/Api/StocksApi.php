...
class StocksApi
{
     ...
     * @return \OpenAPI\Client\Model\DtoStocks[]
     */
    public function stocksGetStocks($database_path, $select = null)
    {
        list($response) = $this->stocksGetStocksWithHttpInfo($database_path, $select);
        return $response;
    }
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\DtoStocks[], HTTP status code, HTTP response headers (array of strings)
     */
    public function stocksGetStocksWithHttpInfo($database_path, $select = null)
    {
        $request = $this->stocksGetStocksRequest($database_path, $select);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\DtoStocks[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\DtoStocks[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\DtoStocks[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\DtoStocks[]',
     ...
     */
    public function stocksGetStocksAsync($database_path, $select = null)
    {
        return $this->stocksGetStocksAsyncWithHttpInfo($database_path, $select)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function stocksGetStocksAsyncWithHttpInfo($database_path, $select = null)
    {
        $returnType = '\OpenAPI\Client\Model\DtoStocks[]';
        $request = $this->stocksGetStocksRequest($database_path, $select);
     ...
     */
    public function stocksGetStocksRequest($database_path, $select = null)
    {
        ...
        if ($database_path === null || (is_array($database_path) && count($database_path) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $database_path when calling stocksGetStocks'
            );
        }
