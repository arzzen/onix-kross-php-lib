...
/**
 * DtoStockItemCode Class Doc Comment
 *
 * @category Class
 * @description Kód skladovej karty
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class DtoStockItemCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DtoStockItemCode';
     ...
     * Sets is_default
     *
     * @param int|null $is_default Indikuje, či daný kód je hlavný kód karty.  -1 - Je hlavným kódom karty.  0 - Nie je hlavným kódom karty.
     *
     * @return self
     */
     ...
     * Sets type_name
     *
     * @param string|null $type_name Typ kódu (EAN, ITF14, ...)
     *
     * @return self
     */
     ...
     * Sets code
     *
     * @param string|null $code Kód skladovej karty
     *
     * @return self
     */
